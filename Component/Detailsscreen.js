...
const Detailsscreen = (props) => {
  ...
  return (
    <ImageBackground
      style={styles.main}
      source={{ uri: `https://image.tmdb.org/t/p/original${props.route.params.backdrop_path}` }}
    ...
    >
      ...
      >
        ...
        >
          ...
          <Text
            style={styles.date}
          > {get_date(props.route.params.release_date)}</Text>
          <View
          ...
          >
            ...
            >
              ...
              >{props.route.params.vote_average} %</Text>
